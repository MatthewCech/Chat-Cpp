...
if _ACTION == nil then error("No action defined!") end
...
function StartProject(proj_name, proj_kind)
  project(proj_name)
    ...
    if proj_kind == nil then proj_kind = "ConsoleApp" end
    kind(proj_kind)
    language   "C++"
    -- The binaries ar output inside the project. If you want them in the root, just prepend: ROOT ..
    targetdir(WORKSPACE .. "bin_" .. proj_name .. "_" .. os.get() .. "_%{cfg.buildcfg}_%{cfg.platform}/");
